...
def enrollment():
    ...
    if courseID:
        if Enrollment.objects(user_id=user_id, courseID=courseID):
            ...
            flash(f"You are enrolled to {courseTitle}", "success")
...
@app.route("/user")
def user():
    # User(user_id=1, first_name="christian", last_name="Hur", email="christian@gmail.com",
    # password="abc1234").save()
    User(user_id=3, first_name="Mary", last_name="Jane", email="mary.jane@gmail.com",
